...
RDebugUtils.currentLine=18939906;
 //BA.debugLineNum = 18939906;BA.debugLine="CustomListView1.Clear";
__ref._customlistview1 /*b4j.example.customlistview*/ ._clear();
RDebugUtils.currentLine=18939907;
 //BA.debugLineNum = 18939907;BA.debugLine="For Each opt As Object In Options";
if (true) break;
...
RDebugUtils.currentLine=18939908;
 //BA.debugLineNum = 18939908;BA.debugLine="CustomListView1.AddTextItem(opt, opt)";
__ref._customlistview1 /*b4j.example.customlistview*/ ._addtextitem(_opt,_opt);
 if (true) break;
if (true) break;
;
RDebugUtils.currentLine=18939910;
 //BA.debugLineNum = 18939910;BA.debugLine="If AllowMultiSelection Then";
...
RDebugUtils.currentLine=18939911;
 //BA.debugLineNum = 18939911;BA.debugLine="Sleep(20)";
...
RDebugUtils.currentLine=18939912;
 //BA.debugLineNum = 18939912;BA.debugLine="For i = 0 To CustomListView1.Size - 1";
if (true) break;
...
RDebugUtils.currentLine=18939913;
 //BA.debugLineNum = 18939913;BA.debugLine="Dim item As CLVItem = CustomListView1.GetRawLis";
_item = __ref._customlistview1 /*b4j.example.customlistview*/ ._getrawlistitem(_i);
RDebugUtils.currentLine=18939914;
 //BA.debugLineNum = 18939914;BA.debugLine="SelectItem (item, False)";
...
RDebugUtils.currentLine=18939917;
 //BA.debugLineNum = 18939917;BA.debugLine="XUIViewsUtils.AddStubToCLVIfNeeded(CustomListView";
...
RDebugUtils.currentLine=18939918;
 //BA.debugLineNum = 18939918;BA.debugLine="SelectedItem = \"\"";
...
RDebugUtils.currentLine=18677764;
 //BA.debugLineNum = 18677764;BA.debugLine="Public Options As List";
_options = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=18677765;
 //BA.debugLineNum = 18677765;BA.debugLine="Public SelectedItem As String";
_selecteditem = "";
RDebugUtils.currentLine=18677766;
 //BA.debugLineNum = 18677766;BA.debugLine="Private xDialog As B4XDialog";
_xdialog = new b4j.example.b4xdialog();
RDebugUtils.currentLine=18677767;
 //BA.debugLineNum = 18677767;BA.debugLine="Public AllowMultiSelection As Boolean";
_allowmultiselection = false;
RDebugUtils.currentLine=18677768;
 //BA.debugLineNum = 18677768;BA.debugLine="Public SelectionColor As Int = 0xAA0086FF";
_selectioncolor = (int) (0xaa0086ff);
RDebugUtils.currentLine=18677769;
 //BA.debugLineNum = 18677769;BA.debugLine="Public SelectedItems As List";
_selecteditems = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=18677770;
 //BA.debugLineNum = 18677770;BA.debugLine="Public MultiSelectionMinimum As Int = 0";
...
RDebugUtils.currentLine=19005440;
 //BA.debugLineNum = 19005440;BA.debugLine="Private Sub SelectItem (Item As CLVItem, Toggle As";
RDebugUtils.currentLine=19005441;
 //BA.debugLineNum = 19005441;BA.debugLine="Dim index As Int = SelectedItems.IndexOf(Item.Val";
_index = __ref._selecteditems /*anywheresoftware.b4a.objects.collections.List*/ .IndexOf(_item.Value);
RDebugUtils.currentLine=19005442;
 //BA.debugLineNum = 19005442;BA.debugLine="Dim Selected As Boolean = index > -1";
_selected = _index>-1;
RDebugUtils.currentLine=19005443;
 //BA.debugLineNum = 19005443;BA.debugLine="If Toggle Then Selected = Not(Selected)";
if (_toggle) { 
_selected = __c.Not(_selected);};
RDebugUtils.currentLine=19005444;
 //BA.debugLineNum = 19005444;BA.debugLine="If Selected Then";
if (_selected) { 
RDebugUtils.currentLine=19005445;
 //BA.debugLineNum = 19005445;BA.debugLine="If Not(Toggle) Then Item.Panel.Color = Selection";
if (__c.Not(_toggle)) { 
_item.Panel.setColor(__ref._selectioncolor /*int*/ );};
RDebugUtils.currentLine=19005446;
 //BA.debugLineNum = 19005446;BA.debugLine="Item.Color = CustomListView1.DefaultTextBackgrou";
...
RDebugUtils.currentLine=19005447;
 //BA.debugLineNum = 19005447;BA.debugLine="If index = -1 Then SelectedItems.Add(Item.Value)";
if (_index==-1) { 
__ref._selecteditems /*anywheresoftware.b4a.objects.collections.List*/ .Add(_item.Value);};
 }else {
RDebugUtils.currentLine=19005449;
 //BA.debugLineNum = 19005449;BA.debugLine="Item.Color = SelectionColor";
_item.Color = __ref._selectioncolor /*int*/ ;
RDebugUtils.currentLine=19005450;
 //BA.debugLineNum = 19005450;BA.debugLine="If Not(Toggle) Then Item.Panel.Color = CustomLis";
if (__c.Not(_toggle)) { 
...
RDebugUtils.currentLine=19005451;
 //BA.debugLineNum = 19005451;BA.debugLine="If index > -1 Then SelectedItems.RemoveAt(index)";
if (_index>-1) { 
__ref._selecteditems /*anywheresoftware.b4a.objects.collections.List*/ .RemoveAt(_index);};
 };
RDebugUtils.currentLine=19005453;
 //BA.debugLineNum = 19005453;BA.debugLine="xDialog.SetButtonState(xui.DialogResponse_Positiv";
...
RDebugUtils.currentLine=18743298;
 //BA.debugLineNum = 18743298;BA.debugLine="mBase.SetLayoutAnimated(0, 0, 0, 300dip, 300dip)";
...
RDebugUtils.currentLine=18743299;
 //BA.debugLineNum = 18743299;BA.debugLine="mBase.LoadLayout(\"ListTemplate\")";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .LoadLayout("ListTemplate",ba);
RDebugUtils.currentLine=18743300;
 //BA.debugLineNum = 18743300;BA.debugLine="mBase.SetColorAndBorder(xui.Color_Transparent, 0,";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetColorAndBorder(__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_Transparent,0,(int) (0),0);
RDebugUtils.currentLine=18743301;
 //BA.debugLineNum = 18743301;BA.debugLine="CustomListView1.sv.SetColorAndBorder(xui.Color_Tr";
...
RDebugUtils.currentLine=18743302;
 //BA.debugLineNum = 18743302;BA.debugLine="CustomListView1.DefaultTextBackgroundColor = 0xFF";
...
RDebugUtils.currentLine=18743303;
 //BA.debugLineNum = 18743303;BA.debugLine="CustomListView1.DefaultTextColor = xui.Color_Whit";
...
RDebugUtils.currentLine=18743305;
 //BA.debugLineNum = 18743305;BA.debugLine="Dim sv As Node = CustomListView1.sv";
...
RDebugUtils.currentLine=18743306;
 //BA.debugLineNum = 18743306;BA.debugLine="sv.StyleClasses.Add(\"b4xdialog\")";
_sv.getStyleClasses().Add((Object)("b4xdialog"));
RDebugUtils.currentLine=18743308;
 //BA.debugLineNum = 18743308;BA.debugLine="Options.Initialize";
__ref._options /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
RDebugUtils.currentLine=18743309;
 //BA.debugLineNum = 18743309;BA.debugLine="SelectedItems.Initialize";
...
RDebugUtils.currentLine=18808834;
 //BA.debugLineNum = 18808834;BA.debugLine="CustomListView1.Base_Resize(Width, Height)";
