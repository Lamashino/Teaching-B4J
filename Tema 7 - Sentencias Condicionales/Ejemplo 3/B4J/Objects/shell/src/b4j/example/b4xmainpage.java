...
public static RemoteObject _lblmostrar = RemoteObject.declareNull("anywheresoftware.b4j.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"btnCalcular",_ref.getField(false, "_btncalcular"),"lblMostrar",_ref.getField(false, "_lblmostrar"),"Root",_ref.getField(false, "_root"),"txtComida",_ref.getField(false, "_txtcomida"),"xui",_ref.getField(false, "_xui")};
}
}