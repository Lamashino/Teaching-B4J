...
;
 BA.debugLineNum = 39;BA.debugLine="fltCoste = fltCoste + 25 'Coste fijo";
Debug.ShouldStop(64);
_fltcoste = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_fltcoste,RemoteObject.createImmutable(25)}, "+",1, 0));Debug.locals.put("fltCoste", _fltcoste);
