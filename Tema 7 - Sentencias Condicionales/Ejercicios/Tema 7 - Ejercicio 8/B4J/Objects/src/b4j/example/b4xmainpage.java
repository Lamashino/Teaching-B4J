...
RDebugUtils.currentLine=7995396;
 //BA.debugLineNum = 7995396;BA.debugLine="Private fltCoste As Float";
_fltcoste = 0f;
RDebugUtils.currentLine=7995398;
 //BA.debugLineNum = 7995398;BA.debugLine="If txtDuración.Text >= 1 And txtDuración.Text < 5";
if ((double)(Double.parseDouble(__ref._txtduración /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))>=1 && (double)(Double.parseDouble(__ref._txtduración /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))<501) { 
RDebugUtils.currentLine=7995399;
 //BA.debugLineNum = 7995399;BA.debugLine="fltCoste = txtDuración.Text * 0.01";
_fltcoste = (float) ((double)(Double.parseDouble(__ref._txtduración /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))*0.01);
 }else 
{RDebugUtils.currentLine=7995400;
 //BA.debugLineNum = 7995400;BA.debugLine="else if txtDuración.Text >= 501 And txtDuración.T";
if ((double)(Double.parseDouble(__ref._txtduración /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))>=501 && (double)(Double.parseDouble(__ref._txtduración /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))<=800) { 
RDebugUtils.currentLine=7995401;
 //BA.debugLineNum = 7995401;BA.debugLine="fltCoste = 500 * 0.01 + (txtDuración.Text - 500)";
_fltcoste = (float) (500*0.01+((double)(Double.parseDouble(__ref._txtduración /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))-500)*0.008);
 }else {
RDebugUtils.currentLine=7995403;
 //BA.debugLineNum = 7995403;BA.debugLine="fltCoste = 500 * 0.01 + 300 * 0.008 + (txtDuraci";
_fltcoste = (float) (500*0.01+300*0.008+((double)(Double.parseDouble(__ref._txtduración /*anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper*/ .getText()))-800)*0.005);
 }}
;
RDebugUtils.currentLine=7995406;
 //BA.debugLineNum = 7995406;BA.debugLine="lblMensaje.Text = \"Coste total = \" & fltCoste & \"";
__ref._lblmensaje /*anywheresoftware.b4j.objects.LabelWrapper*/ .setText("Coste total = "+BA.NumberToString(_fltcoste)+"$");
