...
public class b4xmainpage_subs_3 {
...
__ref.getField(false,"_txtcoste" /*RemoteObject*/ ).runMethod(true,"setText",RemoteObject.concat(__ref.getField(false,"_txtcantidad" /*RemoteObject*/ ).runMethod(true,"getText"),RemoteObject.createImmutable(" x "),_meal,RemoteObject.createImmutable(" "),_fltcoste,RemoteObject.createImmutable(" €")));
