...
public static RemoteObject _lblmensaje2 = RemoteObject.declareNull("anywheresoftware.b4j.objects.LabelWrapper");
public static b4j.example.main _main = null;
public static b4j.example.b4xpages _b4xpages = null;
public static b4j.example.b4xcollections _b4xcollections = null;
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"btnCalcular",_ref.getField(false, "_btncalcular"),"lblMensaje",_ref.getField(false, "_lblmensaje"),"lblMensaje2",_ref.getField(false, "_lblmensaje2"),"lblTotal",_ref.getField(false, "_lbltotal"),"Root",_ref.getField(false, "_root"),"txtMeme",_ref.getField(false, "_txtmeme"),"txtWikipedia",_ref.getField(false, "_txtwikipedia"),"xui",_ref.getField(false, "_xui")};
}
}