...
try {
		Debug.PushSubsStack("Close (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,171);
...
try {
		Debug.PushSubsStack("ContainsKey (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,158);
...
try {
		Debug.PushSubsStack("CreateTable (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,177);
...
try {
		Debug.PushSubsStack("DeleteAll (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,164);
...
try {
		Debug.PushSubsStack("Get (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("GetBitmap (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,124);
...
try {
		Debug.PushSubsStack("GetDefault (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("GetMapAsync (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("Initialize (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,7);
...
try {
		Debug.PushSubsStack("ListKeys (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,146);
...
try {
		Debug.PushSubsStack("Put (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("PutBitmap (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,116);
...
try {
		Debug.PushSubsStack("PutMapAsync (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,70);
...
try {
		Debug.PushSubsStack("Remove (keyvaluestore) ","keyvaluestore",14,__ref.getField(false, "ba"),__ref,141);
