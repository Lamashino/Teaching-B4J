...
try {
		Debug.PushSubsStack("Base_Resize (scrollinglabel) ","scrollinglabel",37,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("getText (scrollinglabel) ","scrollinglabel",37,__ref.getField(false, "ba"),__ref,91);
...
try {
		Debug.PushSubsStack("getTextColor (scrollinglabel) ","scrollinglabel",37,__ref.getField(false, "ba"),__ref,124);
...
try {
		Debug.PushSubsStack("MeasureTextWidth (scrollinglabel) ","scrollinglabel",37,__ref.getField(false, "ba"),__ref,115);
...
try {
		Debug.PushSubsStack("setText (scrollinglabel) ","scrollinglabel",37,__ref.getField(false, "ba"),__ref,43);
...
try {
		Debug.PushSubsStack("setTextColor (scrollinglabel) ","scrollinglabel",37,__ref.getField(false, "ba"),__ref,119);
...
try {
		Debug.PushSubsStack("StartScrolling (scrollinglabel) ","scrollinglabel",37,__ref.getField(false, "ba"),__ref,99);
...
try {
		Debug.PushSubsStack("StopScrolling (scrollinglabel) ","scrollinglabel",37,__ref.getField(false, "ba"),__ref,95);
