...
try {
		Debug.PushSubsStack("AddItemsToList (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,127);
...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("GetPanel (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("Initialize (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,23);
...
try {
		Debug.PushSubsStack("Resize (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,53);
...
try {
		Debug.PushSubsStack("SearchField_EnterPressed (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("SearchField_TextChanged (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("SetItems (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,194);
...
try {
		Debug.PushSubsStack("Show (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,64);
...
try {
		Debug.PushSubsStack("Update (b4xsearchtemplate) ","b4xsearchtemplate",29,__ref.getField(false, "ba"),__ref,84);
