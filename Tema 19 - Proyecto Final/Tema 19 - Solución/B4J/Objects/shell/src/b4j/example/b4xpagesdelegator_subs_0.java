...
try {
		Debug.PushSubsStack("MainForm_Closed (b4xpagesdelegator) ","b4xpagesdelegator",12,__ref.getField(false, "ba"),__ref,13);
...
try {
		Debug.PushSubsStack("MainForm_CloseRequest (b4xpagesdelegator) ","b4xpagesdelegator",12,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("MainForm_FocusChanged (b4xpagesdelegator) ","b4xpagesdelegator",12,__ref.getField(false, "ba"),__ref,9);
...
try {
		Debug.PushSubsStack("MainForm_IconifiedChanged (b4xpagesdelegator) ","b4xpagesdelegator",12,__ref.getField(false, "ba"),__ref,21);
