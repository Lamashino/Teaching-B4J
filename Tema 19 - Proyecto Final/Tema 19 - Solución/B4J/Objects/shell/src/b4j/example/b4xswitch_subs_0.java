...
try {
		Debug.PushSubsStack("Base_Resize (b4xswitch) ","b4xswitch",32,__ref.getField(false, "ba"),__ref,141);
...
try {
		Debug.PushSubsStack("Draw (b4xswitch) ","b4xswitch",32,__ref.getField(false, "ba"),__ref,119);
...
try {
		Debug.PushSubsStack("getEnabled (b4xswitch) ","b4xswitch",32,__ref.getField(false, "ba"),__ref,115);
...
try {
		Debug.PushSubsStack("getValue (b4xswitch) ","b4xswitch",32,__ref.getField(false, "ba"),__ref,106);
...
try {
		Debug.PushSubsStack("Pnl_MouseClicked (b4xswitch) ","b4xswitch",32,__ref.getField(false, "ba"),__ref,67);
...
try {
		Debug.PushSubsStack("setEnabled (b4xswitch) ","b4xswitch",32,__ref.getField(false, "ba"),__ref,110);
...
try {
		Debug.PushSubsStack("setValue (b4xswitch) ","b4xswitch",32,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("SetValueImpl (b4xswitch) ","b4xswitch",32,__ref.getField(false, "ba"),__ref,79);
