...
try {
		Debug.PushSubsStack("getValue (anotherprogressbar) ","anotherprogressbar",16,__ref.getField(false, "ba"),__ref,148);
...
try {
		Debug.PushSubsStack("getVisible (anotherprogressbar) ","anotherprogressbar",16,__ref.getField(false, "ba"),__ref,144);
...
try {
		Debug.PushSubsStack("setValue (anotherprogressbar) ","anotherprogressbar",16,__ref.getField(false, "ba"),__ref,152);
...
try {
		Debug.PushSubsStack("SetValueNoAnimation (anotherprogressbar) ","anotherprogressbar",16,__ref.getField(false, "ba"),__ref,156);
...
try {
		Debug.PushSubsStack("setVisible (anotherprogressbar) ","anotherprogressbar",16,__ref.getField(false, "ba"),__ref,136);
...
try {
		Debug.PushSubsStack("UpdateGraphics (anotherprogressbar) ","anotherprogressbar",16,__ref.getField(false, "ba"),__ref,103);
