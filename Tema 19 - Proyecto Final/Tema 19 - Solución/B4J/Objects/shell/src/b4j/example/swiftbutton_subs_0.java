...
try {
		Debug.PushSubsStack("Base_Resize (swiftbutton) ","swiftbutton",38,__ref.getField(false, "ba"),__ref,53);
...
try {
		Debug.PushSubsStack("Draw (swiftbutton) ","swiftbutton",38,__ref.getField(false, "ba"),__ref,120);
...
try {
		Debug.PushSubsStack("getEnabled (swiftbutton) ","swiftbutton",38,__ref.getField(false, "ba"),__ref,61);
...
try {
		Debug.PushSubsStack("p_MouseClicked (swiftbutton) ","swiftbutton",38,__ref.getField(false, "ba"),__ref,105);
...
try {
		Debug.PushSubsStack("p_Touch (swiftbutton) ","swiftbutton",38,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("SetColors (swiftbutton) ","swiftbutton",38,__ref.getField(false, "ba"),__ref,110);
...
try {
		Debug.PushSubsStack("setEnabled (swiftbutton) ","swiftbutton",38,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("SetPressedState (swiftbutton) ","swiftbutton",38,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("Update (swiftbutton) ","swiftbutton",38,__ref.getField(false, "ba"),__ref,116);
