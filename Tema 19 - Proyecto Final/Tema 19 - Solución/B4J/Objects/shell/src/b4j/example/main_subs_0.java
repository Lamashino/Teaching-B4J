...
b4xpagestudents.myClass = BA.getDeviceClass ("b4j.example.b4xpagestudents");
b4xpagebooks.myClass = BA.getDeviceClass ("b4j.example.b4xpagebooks");
b4xpageborrow.myClass = BA.getDeviceClass ("b4j.example.b4xpageborrow");
b4xpagereturn.myClass = BA.getDeviceClass ("b4j.example.b4xpagereturn");
