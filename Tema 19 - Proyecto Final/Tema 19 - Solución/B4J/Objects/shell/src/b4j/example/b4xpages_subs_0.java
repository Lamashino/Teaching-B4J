...
try {
		Debug.PushSubsStack("AddPage (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,37);
...
try {
		Debug.PushSubsStack("AddPageAndCreate (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,42);
...
try {
		Debug.PushSubsStack("ClosePage (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,62);
...
try {
		Debug.PushSubsStack("GetManager (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,14);
...
try {
		Debug.PushSubsStack("GetNativeParent (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,82);
...
try {
		Debug.PushSubsStack("GetPage (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,27);
...
try {
		Debug.PushSubsStack("GetPageId (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,32);
...
try {
		Debug.PushSubsStack("InternalSetPagesManager (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,19);
...
try {
		Debug.PushSubsStack("IsInitialized (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,9);
...
try {
		Debug.PushSubsStack("MainPage (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,73);
...
try {
		Debug.PushSubsStack("SetTitle (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,68);
...
try {
		Debug.PushSubsStack("ShowPage (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,50);
...
try {
		Debug.PushSubsStack("ShowPageAndRemovePreviousPages (b4xpages) ","b4xpages",6,b4xpages.ba,b4xpages.mostCurrent,56);
