...
try {
		Debug.PushSubsStack("pnlArrow_MouseClicked (b4xplusminus) ","b4xplusminus",28,__ref.getField(false, "ba"),__ref,276);
...
try {
		Debug.PushSubsStack("pnlArrow_MousePressed (b4xplusminus) ","b4xplusminus",28,__ref.getField(false, "ba"),__ref,272);
...
try {
		Debug.PushSubsStack("pnlArrow_MouseReleased (b4xplusminus) ","b4xplusminus",28,__ref.getField(false, "ba"),__ref,280);
