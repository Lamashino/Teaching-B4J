...
public class b4xpagesegundogrado_subs_0 {


public static RemoteObject  _b4xpage_created(RemoteObject __ref,RemoteObject _root1) throws Exception{
try {
		Debug.PushSubsStack("B4XPage_Created (b4xpagesegundogrado) ","b4xpagesegundogrado",3,__ref.getField(false, "ba"),__ref,16);
if (RapidSub.canDelegate("b4xpage_created")) { return __ref.runUserSub(false, "b4xpagesegundogrado","b4xpage_created", __ref, _root1);}
...
try {
		Debug.PushSubsStack("btnCalculate_Click (b4xpagesegundogrado) ","b4xpagesegundogrado",3,__ref.getField(false, "ba"),__ref,25);
if (RapidSub.canDelegate("btncalculate_click")) { return __ref.runUserSub(false, "b4xpagesegundogrado","btncalculate_click", __ref);}
...
Debug.ShouldStop(1);
_d = __ref.runClassMethod (b4j.example.b4xpagesegundogrado.class, "_calcd" /*RemoteObject*/ ,(Object)(_a),(Object)(_b),(Object)(_c));Debug.locals.put("D", _d);
...
if (RemoteObject.solveBoolean("<",_d,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 37;BA.debugLine="xui.MsgboxAsync(\"La ecuación puede resolverse p";
Debug.ShouldStop(16);
__ref.getField(false,"_xui" /*RemoteObject*/ ).runVoidMethod ("MsgboxAsync",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("La ecuación puede resolverse porque Δ < 0")),(Object)(RemoteObject.createImmutable("")));
 }else 
...
__ref.getField(false,"_txtx1" /*RemoteObject*/ ).runMethod(true,"setText",BA.NumberToString(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable((-(double) (0 + _b.<Float>get().floatValue())+b4xpagesegundogrado.__c.runMethod(true,"Sqrt",(Object)(BA.numberCast(double.class, _d))).<Double>get().doubleValue())),(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(2),_a}, "*",0, 0))}, "/",0, 0)));
...
;
 ...
 BA.debugLineNum = 45;BA.debugLine="xui.MsgboxAsync(\"Debes introducir los valores pa";
Debug.ShouldStop(4096);
__ref.getField(false,"_xui" /*RemoteObject*/ ).runVoidMethod ("MsgboxAsync",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("Debes introducir los valores para a, b y c")),(Object)(RemoteObject.createImmutable("")));
 };
...
try {
		Debug.PushSubsStack("calcD (b4xpagesegundogrado) ","b4xpagesegundogrado",3,__ref.getField(false, "ba"),__ref,50);
if (RapidSub.canDelegate("calcd")) { return __ref.runUserSub(false, "b4xpagesegundogrado","calcd", __ref, _a, _b, _c);}
...
b4xpagesegundogrado._root = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_root",b4xpagesegundogrado._root);
 //BA.debugLineNum = 3;BA.debugLine="Private xui As XUI";
b4xpagesegundogrado._xui = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");__ref.setField("_xui",b4xpagesegundogrado._xui);
 //BA.debugLineNum = 4;BA.debugLine="Private txtA As TextField";
b4xpagesegundogrado._txta = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txta",b4xpagesegundogrado._txta);
 //BA.debugLineNum = 5;BA.debugLine="Private txtB As TextField";
b4xpagesegundogrado._txtb = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txtb",b4xpagesegundogrado._txtb);
 //BA.debugLineNum = 6;BA.debugLine="Private txtC As TextField";
b4xpagesegundogrado._txtc = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txtc",b4xpagesegundogrado._txtc);
 //BA.debugLineNum = 7;BA.debugLine="Private txtD As TextField";
b4xpagesegundogrado._txtd = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txtd",b4xpagesegundogrado._txtd);
 //BA.debugLineNum = 8;BA.debugLine="Private txtX1 As TextField";
b4xpagesegundogrado._txtx1 = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txtx1",b4xpagesegundogrado._txtx1);
 //BA.debugLineNum = 9;BA.debugLine="Private txtX2 As TextField";
b4xpagesegundogrado._txtx2 = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txtx2",b4xpagesegundogrado._txtx2);
 //BA.debugLineNum = 10;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _initialize(RemoteObject __ref,RemoteObject _ba) throws Exception{
try {
		Debug.PushSubsStack("Initialize (b4xpagesegundogrado) ","b4xpagesegundogrado",3,__ref.getField(false, "ba"),__ref,12);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "b4xpagesegundogrado","initialize", __ref, _ba);}
