...
public class b4xpagetriangulo_subs_0 {


public static RemoteObject  _b4xpage_created(RemoteObject __ref,RemoteObject _root1) throws Exception{
try {
		Debug.PushSubsStack("B4XPage_Created (b4xpagetriangulo) ","b4xpagetriangulo",4,__ref.getField(false, "ba"),__ref,15);
if (RapidSub.canDelegate("b4xpage_created")) { return __ref.runUserSub(false, "b4xpagetriangulo","b4xpage_created", __ref, _root1);}
...
try {
		Debug.PushSubsStack("btnCalculate_Click (b4xpagetriangulo) ","b4xpagetriangulo",4,__ref.getField(false, "ba"),__ref,26);
if (RapidSub.canDelegate("btncalculate_click")) { return __ref.runUserSub(false, "b4xpagetriangulo","btncalculate_click", __ref);}
...
_c = BA.NumberToString(b4xpagetriangulo.__c.runMethod(true,"Sqrt",(Object)(RemoteObject.solve(new RemoteObject[] {BA.numberCast(double.class, _a),BA.numberCast(double.class, _a),BA.numberCast(double.class, _b),BA.numberCast(double.class, _b)}, "*+*",1, 0))));Debug.locals.put("c", _c);
...
b4xpagetriangulo._root = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_root",b4xpagetriangulo._root);
 //BA.debugLineNum = 3;BA.debugLine="Private xui As XUI 'ignore";
b4xpagetriangulo._xui = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");__ref.setField("_xui",b4xpagetriangulo._xui);
 //BA.debugLineNum = 4;BA.debugLine="Private txtA As TextField";
b4xpagetriangulo._txta = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txta",b4xpagetriangulo._txta);
 //BA.debugLineNum = 5;BA.debugLine="Private txtB As TextField";
b4xpagetriangulo._txtb = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txtb",b4xpagetriangulo._txtb);
 //BA.debugLineNum = 6;BA.debugLine="Private txtC As TextField";
b4xpagetriangulo._txtc = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txtc",b4xpagetriangulo._txtc);
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _initialize(RemoteObject __ref,RemoteObject _ba) throws Exception{
try {
		Debug.PushSubsStack("Initialize (b4xpagetriangulo) ","b4xpagetriangulo",4,__ref.getField(false, "ba"),__ref,10);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "b4xpagetriangulo","initialize", __ref, _ba);}
