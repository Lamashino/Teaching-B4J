...
public class b4xpageprimergrado_subs_0 {


public static RemoteObject  _b4xpage_created(RemoteObject __ref,RemoteObject _root1) throws Exception{
try {
		Debug.PushSubsStack("B4XPage_Created (b4xpageprimergrado) ","b4xpageprimergrado",2,__ref.getField(false, "ba"),__ref,15);
if (RapidSub.canDelegate("b4xpage_created")) { return __ref.runUserSub(false, "b4xpageprimergrado","b4xpage_created", __ref, _root1);}
...
try {
		Debug.PushSubsStack("btnCalculate_Click (b4xpageprimergrado) ","b4xpageprimergrado",2,__ref.getField(false, "ba"),__ref,26);
if (RapidSub.canDelegate("btncalculate_click")) { return __ref.runUserSub(false, "b4xpageprimergrado","btncalculate_click", __ref);}
...
b4xpageprimergrado._root = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");__ref.setField("_root",b4xpageprimergrado._root);
 //BA.debugLineNum = 3;BA.debugLine="Private xui As XUI 'ignore";
b4xpageprimergrado._xui = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");__ref.setField("_xui",b4xpageprimergrado._xui);
 //BA.debugLineNum = 4;BA.debugLine="Private lblMessage As Label";
b4xpageprimergrado._lblmessage = RemoteObject.createNew ("anywheresoftware.b4j.objects.LabelWrapper");__ref.setField("_lblmessage",b4xpageprimergrado._lblmessage);
 //BA.debugLineNum = 5;BA.debugLine="Private txtA As TextField";
b4xpageprimergrado._txta = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txta",b4xpageprimergrado._txta);
 //BA.debugLineNum = 6;BA.debugLine="Private txtB As TextField";
b4xpageprimergrado._txtb = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");__ref.setField("_txtb",b4xpageprimergrado._txtb);
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _initialize(RemoteObject __ref,RemoteObject _ba) throws Exception{
try {
		Debug.PushSubsStack("Initialize (b4xpageprimergrado) ","b4xpageprimergrado",2,__ref.getField(false, "ba"),__ref,10);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "b4xpageprimergrado","initialize", __ref, _ba);}
