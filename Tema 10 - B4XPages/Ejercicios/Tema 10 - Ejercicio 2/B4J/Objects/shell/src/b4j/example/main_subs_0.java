...
b4xpageprimergrado.myClass = BA.getDeviceClass ("b4j.example.b4xpageprimergrado");
b4xpagesegundogrado.myClass = BA.getDeviceClass ("b4j.example.b4xpagesegundogrado");
b4xpagetriangulo.myClass = BA.getDeviceClass ("b4j.example.b4xpagetriangulo");
