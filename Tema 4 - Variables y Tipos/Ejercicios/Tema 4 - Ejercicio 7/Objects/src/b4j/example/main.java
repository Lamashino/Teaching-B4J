...
float _fltsalariobase = 0f;
float _fltsalariototal = 0f;
int _inthijos = 0;
int _intaños = 0;
RDebugUtils.currentLine=196608;
 //BA.debugLineNum = 196608;BA.debugLine="Sub Turtle_Start";
RDebugUtils.currentLine=196617;
 //BA.debugLineNum = 196617;BA.debugLine="Private fltSalarioBase = 400, fltSalarioTotal As";
_fltsalariobase = (float) (400);
_fltsalariototal = 0f;
RDebugUtils.currentLine=196618;
 //BA.debugLineNum = 196618;BA.debugLine="Private intHijos, intAños As Int";
_inthijos = 0;
_intaños = 0;
RDebugUtils.currentLine=196620;
 //BA.debugLineNum = 196620;BA.debugLine="intHijos = 3";
_inthijos = (int) (3);
RDebugUtils.currentLine=196621;
 //BA.debugLineNum = 196621;BA.debugLine="intAños = 14";
_intaños = (int) (14);
RDebugUtils.currentLine=196623;
 //BA.debugLineNum = 196623;BA.debugLine="fltSalarioTotal = fltSalarioBase + intHijos * 30";
_fltsalariototal = (float) (_fltsalariobase+_inthijos*30+_intaños*20);
RDebugUtils.currentLine=196625;
 //BA.debugLineNum = 196625;BA.debugLine="Log(\"Salario total: \" & fltSalarioTotal)";
anywheresoftware.b4a.keywords.Common.Log("Salario total: "+BA.NumberToString(_fltsalariototal));
