...
RDebugUtils.currentLine=196613;
 //BA.debugLineNum = 196613;BA.debugLine="Private intGeo, intAlg, intFis As Int";
_intgeo = 0;
_intalg = 0;
_intfis = 0;
RDebugUtils.currentLine=196614;
 //BA.debugLineNum = 196614;BA.debugLine="Private fltMedia As Float";
_fltmedia = 0f;
RDebugUtils.currentLine=196616;
 //BA.debugLineNum = 196616;BA.debugLine="intGeo = 14";
_intgeo = (int) (14);
RDebugUtils.currentLine=196617;
 //BA.debugLineNum = 196617;BA.debugLine="intAlg = 17";
_intalg = (int) (17);
RDebugUtils.currentLine=196618;
 //BA.debugLineNum = 196618;BA.debugLine="intFis = 12";
_intfis = (int) (12);
RDebugUtils.currentLine=196619;
 //BA.debugLineNum = 196619;BA.debugLine="fltMedia = (intGeo + intAlg + intFis) / 3";
_fltmedia = (float) ((_intgeo+_intalg+_intfis)/(double)3);
RDebugUtils.currentLine=196620;
 //BA.debugLineNum = 196620;BA.debugLine="Log(\"Media = \" & fltMedia)";
anywheresoftware.b4a.keywords.Common.Log("Media = "+BA.NumberToString(_fltmedia));
