...
RDebugUtils.currentLine=196614;
 //BA.debugLineNum = 196614;BA.debugLine="Private fltAncho, fltAlto, fltArea As Float";
_fltancho = 0f;
_fltalto = 0f;
_fltarea = 0f;
RDebugUtils.currentLine=196615;
 //BA.debugLineNum = 196615;BA.debugLine="fltAncho = 123";
_fltancho = (float) (123);
RDebugUtils.currentLine=196616;
 //BA.debugLineNum = 196616;BA.debugLine="fltAlto = 256";
_fltalto = (float) (256);
RDebugUtils.currentLine=196617;
 //BA.debugLineNum = 196617;BA.debugLine="fltArea = fltAncho * fltAlto";
_fltarea = (float) (_fltancho*_fltalto);
RDebugUtils.currentLine=196619;
 //BA.debugLineNum = 196619;BA.debugLine="Log(\"Área: \" & fltArea)";
anywheresoftware.b4a.keywords.Common.Log("Área: "+BA.NumberToString(_fltarea));
