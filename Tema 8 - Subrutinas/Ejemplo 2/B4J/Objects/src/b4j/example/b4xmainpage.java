...
RDebugUtils.currentLine=589832;
 //BA.debugLineNum = 589832;BA.debugLine="Log(CalcularMax(intA, intB, intC))	' Muestra 300";
__c.Log(BA.NumberToString(__ref._calcularmax /*int*/ (null,_inta,_intb,_intc)));
RDebugUtils.currentLine=589833;
 //BA.debugLineNum = 589833;BA.debugLine="End Sub";
return "";
}
public int  _calcularmax(b4j.example.b4xmainpage __ref,int _a,int _b,int _c) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xmainpage";
if (Debug.shouldDelegate(ba, "calcularmax", false))
	 {return ((Integer) Debug.delegate(ba, "calcularmax", new Object[] {_a,_b,_c}));}
int _intm = 0;
RDebugUtils.currentLine=8585216;
 //BA.debugLineNum = 8585216;BA.debugLine="Private Sub CalcularMax(a As Int, b As Int, c As I";
RDebugUtils.currentLine=8585217;
 //BA.debugLineNum = 8585217;BA.debugLine="Private intM As Int";
_intm = 0;
RDebugUtils.currentLine=8585218;
 //BA.debugLineNum = 8585218;BA.debugLine="intM = a";
_intm = _a;
RDebugUtils.currentLine=8585219;
 //BA.debugLineNum = 8585219;BA.debugLine="If b > intM Then";
if (_b>_intm) { 
RDebugUtils.currentLine=8585220;
 //BA.debugLineNum = 8585220;BA.debugLine="intM = b";
_intm = _b;
 };
RDebugUtils.currentLine=8585222;
 //BA.debugLineNum = 8585222;BA.debugLine="If c > intM Then";
if (_c>_intm) { 
RDebugUtils.currentLine=8585223;
 //BA.debugLineNum = 8585223;BA.debugLine="intM = c";
_intm = _c;
 };
RDebugUtils.currentLine=8585226;
 //BA.debugLineNum = 8585226;BA.debugLine="Return(intM)";
