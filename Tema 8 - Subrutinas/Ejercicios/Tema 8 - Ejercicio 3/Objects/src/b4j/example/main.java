...
public static anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper _txtlado = null;
...
public static String  _btndibujar_click() throws Exception{
RDebugUtils.currentModule="main";
if (Debug.shouldDelegate(ba, "btndibujar_click", false))
	 {return ((String) Debug.delegate(ba, "btndibujar_click", null));}
RDebugUtils.currentLine=7733248;
 //BA.debugLineNum = 7733248;BA.debugLine="Private Sub btnDibujar_Click";
RDebugUtils.currentLine=7733249;
 //BA.debugLineNum = 7733249;BA.debugLine="dibujarCuadrado";
_dibujarcuadrado();
RDebugUtils.currentLine=7733250;
 //BA.debugLineNum = 7733250;BA.debugLine="End Sub";
return "";
}
public static String  _dibujarcuadrado() throws Exception{
RDebugUtils.currentModule="main";
if (Debug.shouldDelegate(ba, "dibujarcuadrado", false))
	 {return ((String) Debug.delegate(ba, "dibujarcuadrado", null));}
RDebugUtils.currentLine=7208960;
 //BA.debugLineNum = 7208960;BA.debugLine="Private Sub dibujarCuadrado";
RDebugUtils.currentLine=7208961;
 //BA.debugLineNum = 7208961;BA.debugLine="Turtle.MoveForward(txtLado.Text)";
_turtle._moveforward /*b4j.example.b4xturtle*/ (null,(float)(Double.parseDouble(_txtlado.getText())));
RDebugUtils.currentLine=7208962;
 //BA.debugLineNum = 7208962;BA.debugLine="Turtle.TurnLeft(90)";
_turtle._turnleft /*b4j.example.b4xturtle*/ (null,(float) (90));
RDebugUtils.currentLine=7208964;
 //BA.debugLineNum = 7208964;BA.debugLine="Turtle.MoveForward(txtLado.Text)";
_turtle._moveforward /*b4j.example.b4xturtle*/ (null,(float)(Double.parseDouble(_txtlado.getText())));
RDebugUtils.currentLine=7208965;
 //BA.debugLineNum = 7208965;BA.debugLine="Turtle.TurnLeft(90)";
_turtle._turnleft /*b4j.example.b4xturtle*/ (null,(float) (90));
RDebugUtils.currentLine=7208967;
 //BA.debugLineNum = 7208967;BA.debugLine="Turtle.MoveForward(txtLado.Text)";
_turtle._moveforward /*b4j.example.b4xturtle*/ (null,(float)(Double.parseDouble(_txtlado.getText())));
RDebugUtils.currentLine=7208968;
 //BA.debugLineNum = 7208968;BA.debugLine="Turtle.TurnLeft(90)";
_turtle._turnleft /*b4j.example.b4xturtle*/ (null,(float) (90));
RDebugUtils.currentLine=7208970;
 //BA.debugLineNum = 7208970;BA.debugLine="Turtle.MoveForward(txtLado.Text)";
_turtle._moveforward /*b4j.example.b4xturtle*/ (null,(float)(Double.parseDouble(_txtlado.getText())));
RDebugUtils.currentLine=7208971;
 //BA.debugLineNum = 7208971;BA.debugLine="Turtle.TurnLeft(90)";
_turtle._turnleft /*b4j.example.b4xturtle*/ (null,(float) (90));
