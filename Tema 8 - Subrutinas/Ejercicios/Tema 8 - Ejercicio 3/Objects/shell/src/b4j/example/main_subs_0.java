...
public static RemoteObject  _btndibujar_click() throws Exception{
try {
		Debug.PushSubsStack("btnDibujar_Click (main) ","main",0,main.ba,main.mostCurrent,43);
if (RapidSub.canDelegate("btndibujar_click")) { return b4j.example.main.remoteMe.runUserSub(false, "main","btndibujar_click");}
 BA.debugLineNum = 43;BA.debugLine="Private Sub btnDibujar_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 44;BA.debugLine="dibujarCuadrado";
...
public static RemoteObject  _dibujarcuadrado() throws Exception{
try {
		Debug.PushSubsStack("dibujarCuadrado (main) ","main",0,main.ba,main.mostCurrent,47);
if (RapidSub.canDelegate("dibujarcuadrado")) { return b4j.example.main.remoteMe.runUserSub(false, "main","dibujarcuadrado");}
 BA.debugLineNum = 47;BA.debugLine="Private Sub dibujarCuadrado";
Debug.ShouldStop(16384);
 BA.debugLineNum = 48;BA.debugLine="Turtle.MoveForward(txtLado.Text)";
Debug.ShouldStop(32768);
main._turtle.runClassMethod (b4j.example.b4xturtle.class, "_moveforward" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, main._txtlado.runMethod(true,"getText"))));
 BA.debugLineNum = 49;BA.debugLine="Turtle.TurnLeft(90)";
Debug.ShouldStop(65536);
main._turtle.runClassMethod (b4j.example.b4xturtle.class, "_turnleft" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 90)));
 BA.debugLineNum = 51;BA.debugLine="Turtle.MoveForward(txtLado.Text)";
Debug.ShouldStop(262144);
main._turtle.runClassMethod (b4j.example.b4xturtle.class, "_moveforward" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, main._txtlado.runMethod(true,"getText"))));
 BA.debugLineNum = 52;BA.debugLine="Turtle.TurnLeft(90)";
Debug.ShouldStop(524288);
main._turtle.runClassMethod (b4j.example.b4xturtle.class, "_turnleft" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 90)));
 BA.debugLineNum = 54;BA.debugLine="Turtle.MoveForward(txtLado.Text)";
Debug.ShouldStop(2097152);
main._turtle.runClassMethod (b4j.example.b4xturtle.class, "_moveforward" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, main._txtlado.runMethod(true,"getText"))));
 BA.debugLineNum = 55;BA.debugLine="Turtle.TurnLeft(90)";
Debug.ShouldStop(4194304);
main._turtle.runClassMethod (b4j.example.b4xturtle.class, "_turnleft" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, 90)));
 BA.debugLineNum = 57;BA.debugLine="Turtle.MoveForward(txtLado.Text)";
Debug.ShouldStop(16777216);
main._turtle.runClassMethod (b4j.example.b4xturtle.class, "_moveforward" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, main._txtlado.runMethod(true,"getText"))));
 BA.debugLineNum = 58;BA.debugLine="Turtle.TurnLeft(90)";
...
main._menubar1 = RemoteObject.createNew ("anywheresoftware.b4j.objects.MenuItemWrapper.MenuBarWrapper");
 //BA.debugLineNum = 14;BA.debugLine="Private txtLado As TextField";
main._txtlado = RemoteObject.createNew ("anywheresoftware.b4j.objects.TextInputControlWrapper.TextFieldWrapper");
